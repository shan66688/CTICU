...
```{r}
glmdata <- desdata %>% mutate( IHV_24 = IHV)
glmdata$IHV_24[desdata$IHV>24] = NA 
```
...
g <- ggplot(desdata, aes(desdata$OREhour, desdata$IHV))
...
full_logistic_fit <- glm(formula= period ~ IHV_24+ age+
       sex+
