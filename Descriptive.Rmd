...
#desdata$Ethnicity[desdata$Ethnicity == "Not documented"] <- NA
length(desdata$Ethnicity)
sum(is.na(desdata$Ethnicity))
sum(is.na(desdata$Ethnicity)) / length(desdata$Ethnicity)
table(desdata$Ethnicity)

#table(desdata$Ethnicity) / length(desdata$Ethnicity)
paste(round(100*(table(desdata$Ethnicity) / 861), 2), "%", sep="")

length(desdata$Ethnicity[desdata$period == "P1"])
length(desdata$Ethnicity[desdata$period == "P2"])

sum(is.na(desdata$Ethnicity[desdata$period == "P1"]))
sum(is.na(desdata$Ethnicity[desdata$period == "P2"]))

table(desdata$Ethnicity[desdata$period == "P1"]) 
table(desdata$Ethnicity[desdata$period == "P2"]) 

#table(desdata$Ethnicity[desdata$period == "P1"]) / length(desdata$Ethnicity[desdata$period == "P1"])
paste(round(100*(table(desdata$Ethnicity[desdata$period == "P1"]) / length(desdata$Ethnicity[desdata$period == "P1"])), 2), "%", sep="")

#table(desdata$Ethnicity[desdata$period == "P2"]) / length(desdata$Ethnicity[desdata$period == "P2"])
paste(round(100*(table(desdata$Ethnicity[desdata$period == "P2"]) / length(desdata$Ethnicity[desdata$period == "P2"])), 2), "%", sep="")


chisq.test(desdata$Ethnicity,desdata$period, correct = FALSE)
```
...
glmdata$period <- as.factor(glmdata$period)
