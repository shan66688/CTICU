...
```{r}
desdata$OREhour<- as.numeric(desdata$OREhour )
...
desdata$period <- "P2"
#desdata$period[desdata$OREhour >=18] = "P2"
#desdata$period[desdata$OREhour < 06] ="P1"
desdata$period[desdata$OREhour <18 & desdata$OREhour >=7 ] = "P1"
sum(desdata$OREhour <18 & desdata$OREhour >=7)
sum(desdata$period == "P1")
sum(desdata$period == "P2")
```
